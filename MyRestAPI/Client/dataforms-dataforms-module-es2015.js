...
let AgtableComponent = class AgtableComponent {
    constructor(ss) {
        this.ss = ss;
    ...
    ngOnInit() {
        this.ss.getSupplyMaster().subscribe((data) => this.rows = data, () => this.rows = []);
    }
};
...
let CrudformComponent = class CrudformComponent {
    constructor(formbuilder, es, router) {
...
let DataformsModule = class DataformsModule {
};
...
//# sourceMappingURL=dataforms-dataforms-module-es2015.js.map